                      ...
                      byte_data_size[1])
{
  ...
  if ((index_data == 0.0) && (len_data == 0.0)) {
    ...
    if (brm > data->size[1]) {
      ...
      unnamed_idx_1 = static_cast<int>(brm - static_cast<double>(data->size[1]));
    ...
    brm = Q + (static_cast<double>(unnamed_idx_1) - 1.0);
    if (unnamed_idx_1 > brm) {
      i = -1;
      i1 = -1;
    } else {
      i = unnamed_idx_1 - 2;
    ...
    if (z_data[9].im == 0.0) {
      ...
      if (brm > b_r) {
        ...
        re = (del.re * b_r + del.im * Q) / brm;
        b_r = (del.im * b_r - del.re * Q) / brm;
      } else {
    ...
    for (i1 = 0; i1 < nx; i1++) {
      ...
      brm = z_data[k].re;
      Q = z_data[k].im;
      b_z_data[i1].re = brm * re - Q * b_r;
      b_z_data[i1].im = brm * b_r + Q * re;
    }
    ...
    for (i1 = 0; i1 < nx; i1++) {
      ...
      brm = z_data[k].re;
      Q = z_data[k].im;
      qam_symbols_data[i1].re = brm * re - Q * b_r;
      qam_symbols_data[i1].im = brm * b_r + Q * re;
    }
