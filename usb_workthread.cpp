        ...
        if(start_transmit)
        {
            ...
            if(testStartBlockingReceive)
            {
                ...
                while(1)
                {
                    ...
                    //res = libusb_bulk_transfer(handle, EP_IN, UserRxBuffer + UserRxBuffer_len, 890000, &actual_length, 1000);
                    //res = libusb_bulk_transfer(handle, EP_IN, UserRxBuffer + UserRxBuffer_len, sizeof(UserRxBuffer)/10, &actual_length, 1000);
                    //res = libusb_bulk_transfer(handle, EP_IN, UserRxBuffer + UserRxBuffer_len, sizeof(UserRxBuffer)/5, &actual_length, 1000);
                    res = libusb_bulk_transfer(handle, EP_IN, UserRxBuffer + UserRxBuffer_len, 8192+1, &actual_length, 1000);
